  ...
  <div id="app" >
    <nav class="navbar navbar-inverse navbar-fixed-top" >
      <div class="navbar-header page-scroll">
        ...
        <!-- Branding Image -->
        <!--<img class="navbar-brand" href="{{url('')}}" src="images/logo.png" alt="">-->
        <a class="navbar-brand" href="{{url('')}}">
            <!--{{ config('app.name') }}-->
            <img src="images/logo-tiketku.png" alt="">
        </a>
      </div>
  ...
  <footer class="footer-bs">
    <div class="row">
      <div class="col-md-3 footer-brand animated fadeInLeft">
        ...
        <p>{{config('app.name')}} Booking tiket pesawat mudah dan aman</p>
        <p>© 2020 {{config('app.name')}}, All rights reserved</p>
      </div>
...
<section style="text-align:center; margin:10px auto;"><p>Copyright <a href="#">{{config('app.name')}} 2020</a></p></section>
