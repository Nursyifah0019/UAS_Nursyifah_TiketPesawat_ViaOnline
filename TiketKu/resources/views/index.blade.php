  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      ...
      <div class="carousel-caption">
       <h1>TiketKu Memberikan Kemudahan dalam memilih Tiket Perjalanan anda</h1>
      </div>
    </div>
    <div class="item">
      <img src="images/banner3.jpg" alt="...">
      <div class="carousel-caption">
       <h1>TiketKu Memberikan Harga yang relatif murah dan tersedia berbagai macam pilihan tiket</h1>
      </div>
    </div>
    ...
    <div class="item">
      ...
      <div class="carousel-caption">
        <h1>TiketKu Memberikan pilihan Maskapai Terbaik untuk Perjalanan Anda</h1>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">Kenapa Harus di TiketKu?</h2>
        </div>
    </div>
    ...
    <div class="row text-center">
      ...
      <div class="col-md-4">
          ...
          <p class="text-muted">Dengan pencarian satu klik, temukan tiket Pesawat ke 100.000 rute untuk penerbangan di seluruh Asia Pasifik dan Eropa.</p>
      </div>

      <div class="col-md-4">
          <img src="images/pay.png" alt="">
          <h4 class="service-heading">Transaksi Dijamin Aman</h4>
...
<section id="partners">
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        <h2 class="section-heading text-uppercase" id="test">Partner Maskapai</h2>
