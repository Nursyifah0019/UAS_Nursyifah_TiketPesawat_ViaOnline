...
<html lang="{{ app()->getLocale() }}">
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <!--<a class="navbar-brand" href="#"><span>Tiket</span>Ku</a>-->
    ...
    <!-- menu -->
        ...
        <ul class="nav menu">
            <li><a href="{{ url('admin')}}"><em class="fa fa-dashboard"></em> Dashboard</a></li>
            ...
            <li class="parent "><a data-toggle="collapse" href="#sub-item-1">
                <em class="fa fa-database">&nbsp;</em> Manage Data <span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><em class="fa fa-plus"></em></span>
                </a>
                <ul class="children collapse" id="sub-item-1">
                    <li>
                        <a class="" href="{{ url('admin/airport') }}"><span class="fa fa-building-o"></span> Airports</a>
                    </li>
                    <li>
                        <a class="" href="{{ url('admin/plane') }}"><span class="fa fa-plane"></span> Planes</a>
                    </li>
                    <li>
                        <a class="" href="{{ url('admin/plane/schedule/index') }}"><span class="fa fa-book"></span> Schedule</a>
                    </li>
                </ul>
            </li>
            <li>
